...
-inputfile : input file must contain the species and the gene phylogenetic trees in the Newick format (the species tree must be reported first)
             the trees can be rooted; if they are unrooted, they will be rooted by midpoint (default option)
...
======================
 ...
 -------------------------------------------------------------------------------
 | ((J:1.0,A:1.0):1.0,((C:1.0,E:1.0):10.0,(G:1.0,(F:1.0,H:1.0):1.0):1.0):1.0); |    -> species tree in the Newick format
 | ((J:1.0,F:1.0):1.0,((C:1.0,G:1.0):1.0,(E:1.0,(A:1.0,H:1.0):1.0):1.0):1.0);  |    -> gene tree in the Newick format
 -------------------------------------------------------------------------------
...
If the species and (or) gene tree(s) are not rooted, the root position(s) can be specified in the species root (speciesRootLeaves.txt) and (or) gene root (or geneRootLeaves.txt) file(s) as follows: 
 ...
 ------------------------
 | C E F H G            | -> list of species in the first part of the bipartition induced by the tree root
 | <>                   |
 | J A                  | -> list of species in the second part of the bipartition induced by the tree root
 ------------------------
...
An example of a FORMATTED OUTPUT file:
 ...
 |  This program computes a unique scenario of horizontal gene transfers (HGTs) for	
 |  the given pair of species and gene phylogenetic trees.				
 | =================================================================================	
 |											
